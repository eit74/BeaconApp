...
public class RestConnection implements ConnectionInterface {
     ...
     */
    private void buildCerfiticate() throws CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
